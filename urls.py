...
urlpatterns = [
    ...
    url(r'^figure/tst/superfamily/id/(?P<homsf_id>[\d,\.]+)/$', views.scatterplot_domain,name='scatterplot_homsf'),
    url(r'^figure/tst/superfamily/$', views.scatterplot_homsf,name='fig_nbscatter'),
    url(r'^figure/tst/domain/$', views.scatterplot_domain,name='scatterplot_homsf'),
