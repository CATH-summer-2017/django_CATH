    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Class', models.IntegerField(db_index=True, default=0, null=True)),
                ('arch', models.IntegerField(db_index=True, default=0, null=True)),
                ('topo', models.IntegerField(db_index=True, default=0, null=True)),
                ('homsf', models.IntegerField(db_index=True, default=0, null=True)),
                ('s35', models.IntegerField(db_index=True, default=0, null=True)),
                ('s60', models.IntegerField(default=0, null=True)),
                ('s95', models.IntegerField(default=0, null=True)),
                ('s100', models.IntegerField(default=0, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='domain',
